<template>
    <section
            class="bg-[url('/images/bg.jpg')] bg-no-repeat bg-cover bg-center bg-gray-700 bg-blend-multiply bg-opacity-60">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen pt:mt-0">
            ...
            <div
                ...
                <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
                    ...
                    <RouterLink v-slot="{ navigate }" to="/forgot-password-message" custom>
                        <button type="submit"
                                @click="navigate"
